...
const profile = {
    ...
    2: { name: 'Music бот на заказ', description: `Музыкальный-бот на ${sim['nodejs']}`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/me/items/buy-3', title: 'Купить скрипт бота' }, date: 'Услуга', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '199₽', link: './items/buy-3', color: '#3ba55c' } },
    3: { new: true, name: 'Mod бот на заказ', description: `Модератор-бот на ${sim['nodejs']}`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/me/items/buy-3', title: 'Купить скрипт бота' }, date: 'Услуга', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '499₽', link: './items/buy-4', color: '#3ba55c' } },
    4: { name: 'FN bot#0209', description: `Мультифункциональный односерверный бот на ${sim['nodejs']}, в которого входят: 65+ команд для модерации/музыки/фана...`, icon: 'https://cdn.discordapp.com/avatars/674942800894361611/568429c0828ceabc102df5dd5617d907.webp?size=4096', buttonShare: { link: 'https://zippw.github.io/me/items/buy-1', title: 'Купить скрипт бота' }, date: 'Дата: 3/4/2021', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '699₽', link: './items/buy-1', color: '#3ba55c' } },
    5: { name: 'Slash bot#3799', description: `Slash бот с глобальными командами на ${sim['nodejs']}, который включает в себя несколько команд <br>новейшего хэндлера...`, icon: 'https://cdn.discordapp.com/avatars/783995245075103744/405ff76ecd30ee7943f29023d59eea22.webp?size=4096', buttonShare: { link: 'https://zippw.github.io/me/items/buy-2', title: 'Купить скрипт бота' }, date: 'Дата: 7/05/2021', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '199₽', link: './items/buy-2', color: '#3ba55c' } },
    6: { name: 'Альбом Выва 2 | 2021', description: `4 трека;<br>площадка ${sim['youtube']}`, icon: './img/avatars/soundcloud_avatar.jpg', buttonShare: { link: 'https://youtube.com/playlist?list=PL2KqJq9LIGN7q1zGbuYIi5jXvtamjrseQ', title: 'Перейти на YouTube плейлист' }, date: 'Дата: 23/4/2021', bg: 'url(./img/bgs/bg2.jpg)', color: '', button: { title: 'YouTube', link: 'https://youtube.com/playlist?list=PL2KqJq9LIGN7q1zGbuYIi5jXvtamjrseQ', color: '#ff0000' } },
    7: { name: 'Альбом Выва 2 | 2021', description: `4 трека; <br>площадка: ${sim['soundcloud']}`, icon: './img/avatars/soundcloud_avatar.jpg', buttonShare: { link: 'https://soundcloud.com/valeriy-is-bro-vp/sets/2-1', title: 'Перейти на SoundCloud плейлист' }, date: 'Дата: 23/4/2021', bg: 'url(./img/bgs/bg2.jpg)', color: '', button: { title: 'SoundCloud', link: 'https://soundcloud.com/valeriy-is-bro-vp/sets/2-1', color: '#ff7400' } },
    8: { new: true, name: 'Альбом Выва | 2020', description: `3 трека, никуда не выкладывал`, icon: '', buttonShare: { link: '', title: 'Ссылка отсутствует' }, date: 'Дата: ?/?/2020', bg: '', color: '', button: { title: '⠀x⠀', link: '', color: '' } },
    9: { new: true, name: 'Временной отсчёт sPoint', description: `Написано на Java ${sim['java']}`, icon: './img/avatars/spoint.png', buttonShare: { link: 'https://zippw.github.io/me/items/program-1.html', title: 'Скопировать ссылку на страницу скачивания' }, date: 'Дата: ?/?/2018', bg: '', color: '', button: { title: 'Скачать', link: './items/program-1.html', color: '' } },
}
...
w                                                alt="${profile[i].name}" loading="lazy"
                                            ...
                                            <h5 class="portfolio__card-title">
                                                <a href="${profile[i].button.link}"
                                                    id="portfolio__card-hide" class="partner-va">${profile[i].name}</a><br><span style="font-family: 'Montserrat Medium', sans-serif; margin-top: 10px;"
