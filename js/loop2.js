...
<br>Музыкальный-бот на ${sim['nodejs']}`,
        ...
        buttonShare: { link: 'https://zippw.github.io/zippp/items/buy-3.html', title: 'Купить скрипт бота' },
        date: 'Услуга',
        bg: 'bg1.jpg',
        color: '',
    ...
    2: {
        ...
        buttonShare: { link: 'https://zippw.github.io/zippp/items/buy-1.html', title: 'Купить скрипт бота' },
        date: 'Дата: 3/4/2021',
        bg: 'bg1.jpg',
        color: '',
    ...
    3: {
        ...
        buttonShare: { link: 'https://zippw.github.io/zippp/items/buy-2.html', title: 'Купить скрипт бота' },
        date: 'Дата: 7/05/2021',
        bg: 'bg1.jpg',
        color: '',
