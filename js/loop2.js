...
<br>Музыкальный-бот на ${sim['nodejs']}`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/me/items/buy-3', title: 'Купить скрипт бота' }, date: 'Услуга', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '499₽', link: './items/buy-3', color: '#3ba55c' }
    ...
    2: { name: 'FN bot#0209', description: `Мультифункциональный односерверный бот на ${sim['nodejs']}, в которого входят: 65+ команд для модерации/музыки/фана...`, icon: 'https://cdn.discordapp.com/avatars/674942800894361611/568429c0828ceabc102df5dd5617d907.webp?size=4096', buttonShare: { link: 'https://zippw.github.io/me/items/buy-1', title: 'Купить скрипт бота' }, date: 'Дата: 3/4/2021', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '1999₽', link: './items/buy-1', color: '#3ba55c' } },
