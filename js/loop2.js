...
const profile = {
    ...
    9: { new: true, name: 'Временной отсчёт sPoint', description: `Написано на Java ${sim['java']}`, icon: '', buttonShare: { link: 'https://zippw.github.io/me/items/program-1.html', title: 'Скопировать ссылку на страницу скачивания' }, date: 'Дата: ?/?/2018', bg: '', color: '', button: { title: 'Скачать', link: './items/program-1.html', color: '' } },
}
