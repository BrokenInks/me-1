...
<br>Музыкальный-бот на ${sim['nodejs']}`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/me/items/buy-3.html', title: 'Купить скрипт бота' }, date: 'Услуга', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '499₽', link: './items/buy-3.html', color: '#3ba55c' }
    ...
    6: { name: 'Приложение с ботом', description: `Бэкенд: !=#2988`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/items/program', title: 'Перейди на страницу скачивания бота-программы' }, date: 'Дата: 26/6/2021', bg: '#2c2f33', color: '', button: { title: 'Скачать', link: './items/program', color: '#2c2f33' } },
}
