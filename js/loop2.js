...
<br>Музыкальный-бот на ${sim['nodejs']}`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/me/items/buy-3.html', title: 'Купить скрипт бота' }, date: 'Услуга', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '499₽', link: './items/buy-3.html', color: '#3ba55c' }
    },
    2: { name: 'FN bot#0209', description: `Мультифункциональный односерверный бот на ${sim['nodejs']}, в которого входят: 65+ команд для модерации/музыки/фана...`, icon: 'https://cdn.discordapp.com/avatars/674942800894361611/568429c0828ceabc102df5dd5617d907.webp?size=4096', buttonShare: { link: 'https://zippw.github.io/me/items/buy-1.html', title: 'Купить скрипт бота' }, date: 'Дата: 3/4/2021', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '1999₽', link: './items/buy-1.html', color: '#3ba55c' } },
    3: { name: 'Slash bot#3799', description: `Slash бот с глобальными командами на ${sim['nodejs']}, который включает в себя несколько команд <br>новейшего хэндлера...`, icon: 'https://cdn.discordapp.com/avatars/783995245075103744/405ff76ecd30ee7943f29023d59eea22.webp?size=4096', buttonShare: { link: 'https://zippw.github.io/me/items/buy-2.html', title: 'Купить скрипт бота' }, date: 'Дата: 7/05/2021', bg: 'url(./img/bgs/bg1.jpg)', color: '', button: { title: '199₽', link: './items/buy-2.html', color: '#3ba55c' } },
    4: { name: 'Альбом Выва | 2021', description: `4 трека;<br>площадка ${sim['youtube']}`, icon: './img/avatars/soundcloud_avatar.jpg', buttonShare: { link: 'https://youtube.com/playlist?list=PL2KqJq9LIGN7q1zGbuYIi5jXvtamjrseQ', title: 'Перейти на YouTube плейлист' }, date: 'Дата: 23/4/2021', bg: 'url(./img/bgs/bg2.jpg)', color: '', button: { title: 'YouTube', link: 'https://youtube.com/playlist?list=PL2KqJq9LIGN7q1zGbuYIi5jXvtamjrseQ', color: '#ff0000' } },
    5: { name: 'Альбом Выва | 2021', description: `4 трека; <br>площадка: ${sim['soundcloud']}`, icon: './img/avatars/soundcloud_avatar.jpg', buttonShare: { link: 'https://soundcloud.com/valeriy-is-bro-vp/sets/2-1', title: 'Перейти на SoundCloud плейлист' }, date: 'Дата: 23/4/2021', bg: 'url(./img/bgs/bg2.jpg)', color: '', button: { title: 'SoundCloud', link: 'https://soundcloud.com/valeriy-is-bro-vp/sets/2-1', color: '#ff7400' } },
    6: { name: 'Приложение с ботом', description: `Бэкенд: !=#2988`, icon: './img/avatars/1.gif', buttonShare: { link: 'https://zippw.github.io/items/program', title: 'Перейди на страницу скачивания бота-программы' }, date: 'Дата: 26/6/2021', bg: 'url(./img/bgs/violet-background-brightness-laptop-device-gears-mechanism-set-program-windows-programming-language-codes-vector-111990512.jpg)', color: '', button: { title: 'Скачать', link: './items/program', color: '#2c2f33' } },
}
